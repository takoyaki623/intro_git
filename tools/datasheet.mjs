...
<section id="s-calc">
  ...
  <div class="formulas">
    <div class="formula">
      <h3>ステータス</h3>
      <pre>HP   = ⌊(種族値×2 + 個体値 + ⌊努力値÷4⌋) × Lv ÷ 100⌋ + Lv + 10
その他 = ⌊(⌊(種族値×2 + 個体値 + ⌊努力値÷4⌋) × Lv ÷ 100⌋ + 5) × せいかく⌋</pre>
      <p>個体値は0〜31で、捕まえた瞬間に6つとも決まります。
      努力値は倒した相手の「一番高い種族値」に入り、1つ252・合計510が上限です。
      せいかくは25種あり、ひとつを1.1倍・別のひとつを0.9倍にします（HPは対象外、5種は補正なし）。</p>
    </div>
    <div class="formula">
      <h3>ダメージ</h3>
