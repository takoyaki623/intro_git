...
import { SPR, SPR_BACK } from './sprites/monsters.js';
...
export const SPECIES = {
  ...
  3: {
    ...
    evolution: null,
    catchRate: 45, baseExp: 236, expType: 'mediumSlow', sprite: SPR.fushigibana, backSprite: SPR_BACK.fushigibana,
  ...
  6: {
    ...
    tm: ['のしかかり', 'かえんほうしゃ', 'かみつく'],
    evolution: null,
    catchRate: 45, baseExp: 240, expType: 'mediumSlow', sprite: SPR.rizaadon, backSprite: SPR_BACK.rizaadon,
  ...
  9: {
    ...
    tm: ['のしかかり', 'なみのり', 'かみつく'],
    evolution: null,
    catchRate: 45, baseExp: 239, expType: 'mediumSlow', sprite: SPR.kamekkusu, backSprite: SPR_BACK.kamekkusu,
    height: 1.6, weight: 85.5,
    dex: 'こうらの ほうすいこうから ひとを ふきとばす いきおいの みずを はっしゃする。',
  },

  10: {
    name: 'キャタピー', types: ['むし'], ability: 'むしのしらせ',
  ...
  11: {
    name: 'トランセル', types: ['むし'], ability: 'むしのしらせ',
  ...
  12: {
    name: 'バタフリー', types: ['むし', 'ひこう'], ability: 'むしのしらせ',
  ...
  16: {
    name: 'ポッポ', types: ['ノーマル', 'ひこう'], ability: 'いかく',
  ...
  17: {
    name: 'ピジョン', types: ['ノーマル', 'ひこう'], ability: 'いかく',
  ...
  26: {
    ...
    evolution: null,
    catchRate: 75, baseExp: 218, expType: 'mediumFast', sprite: SPR.raichuu, backSprite: SPR_BACK.raichuu,
  ...
  // ---------- どうくつ ----------
  41: {
    name: 'ズバット', types: ['どく', 'ひこう'], ability: 'ふゆう',
  ...
  42: {
    name: 'ゴルバット', types: ['どく', 'ひこう'], ability: 'ふゆう',
  ...
  130: {
    ...
    evolution: null,
    catchRate: 45, baseExp: 189, expType: 'slow', sprite: SPR.gyaradosu, backSprite: SPR_BACK.gyaradosu,
  ...
  // ---------- 御三家（みず・3世代） ----------
  258: {
    name: 'ミズゴロウ', types: ['みず'], gen: 3, ability: 'げきりゅう',
  ...
  259: {
    name: 'ヌマクロー', types: ['みず', 'じめん'], gen: 3, ability: 'げきりゅう',
  ...
  260: {
    name: 'ラグラージ', types: ['みず', 'じめん'], gen: 3, ability: 'げきりゅう',
    ...
    tm: ['のしかかり', 'なみのり', 'かみつく'],
    evolution: null,
    catchRate: 45, baseExp: 241, expType: 'mediumSlow', sprite: SPR.ragurajji, backSprite: SPR_BACK.ragurajji,
  ...
  // ---------- 御三家（くさ・7世代） ----------
  722: {
    name: 'モクロー', types: ['くさ', 'ひこう'], gen: 7, ability: 'しんりょく',
  ...
  723: {
    name: 'フクスロー', types: ['くさ', 'ひこう'], gen: 7, ability: 'しんりょく',
  ...
  724: {
    name: 'ジュナイパー', types: ['くさ', 'ゴースト'], gen: 7, ability: 'しんりょく',
  ...
  // ---------- エスパー・フェアリー（3世代） ----------
  280: {
    name: 'ラルトス', types: ['エスパー', 'フェアリー'], gen: 3, ability: 'ふゆう',
  ...
  281: {
    name: 'キルリア', types: ['エスパー', 'フェアリー'], gen: 3, ability: 'ふゆう',
  ...
  // ---------- かくとう・はがね（4世代） ----------
  447: {
    name: 'リオル', types: ['かくとう'], gen: 4, ability: 'がんじょう',
  ...
  448: {
    name: 'ルカリオ', types: ['かくとう', 'はがね'], gen: 4, ability: 'がんじょう',
    ...
    evolution: null,
    catchRate: 45, baseExp: 184, expType: 'mediumSlow', sprite: SPR.rukario, backSprite: SPR_BACK.rukario,
  ...
  // ---------- こおり・むし（8世代） ----------
  872: {
    name: 'ユキハミ', types: ['こおり', 'むし'], gen: 8, ability: 'むしのしらせ',
  ...
  873: {
    name: 'モスノウ', types: ['こおり', 'むし'], gen: 8, ability: 'むしのしらせ',
  ...
  // ---------- ノーマル・ひこう（4世代） ----------
  396: {
    name: 'ムックル', types: ['ノーマル', 'ひこう'], gen: 4, ability: 'いかく',
  ...
  397: {
    name: 'ムクバード', types: ['ノーマル', 'ひこう'], gen: 4, ability: 'いかく',
  ...
  // ---------- でんき（9世代） ----------
  921: {
    name: 'パモ', types: ['でんき'], gen: 9, ability: 'せいでんき',
  ...
  // ---------- でんき（2世代） ----------
  179: {
    name: 'メリープ', types: ['でんき'], gen: 2, ability: 'せいでんき',
  ...
  180: {
    name: 'モココ', types: ['でんき'], gen: 2, ability: 'せいでんき',
  ...
  // ---------- ノーマル・ひこう（6世代） ----------
  661: {
    name: 'ヤヤコマ', types: ['ノーマル', 'ひこう'], gen: 6, ability: 'もうか',
  ...
  662: {
    name: 'ヒノヤコマ', types: ['ノーマル', 'ひこう'], gen: 6, ability: 'もうか',
  ...
  76: {
    ...
    tm: ['じしん', 'いわなだれ'],
    evolution: null,
    catchRate: 45, baseExp: 223, expType: 'mediumSlow', sprite: SPR.goroonya, backSprite: SPR_BACK.goroonya,
    height: 1.4, weight: 300.0,
    dex: 'ぜんしんが がんせきで できている。やまを ころがりおちる いきおいは れっしゃにも まけない。',
  },
  282: {
    name: 'サーナイト', types: ['エスパー', 'フェアリー'], gen: 3, ability: 'ふゆう',
    ...
    tm: ['ねんりき', 'マジカルシャイン'],
    evolution: null,
    catchRate: 45, baseExp: 233, expType: 'mediumSlow', sprite: SPR.saanaito, backSprite: SPR_BACK.saanaito,
  ...
  635: {
    ...
    tm: ['かみつく', 'ドラゴンクロー'],
    evolution: null,
    catchRate: 45, baseExp: 270, expType: 'slow', sprite: SPR.sazandora, backSprite: SPR_BACK.sazandora,
  ...
  181: {
    name: 'デンリュウ', types: ['でんき'], gen: 2, ability: 'せいでんき',
  ...
  169: {
    name: 'クロバット', types: ['どく', 'ひこう'], gen: 2, ability: 'ふゆう',
    ...
    tm: ['ヘドロばくだん', 'エアスラッシュ'],
    evolution: null,
    catchRate: 45, baseExp: 241, expType: 'mediumFast', sprite: SPR.kurobatto, backSprite: SPR_BACK.kurobatto,
    height: 1.8, weight: 75.0,
    dex: 'よん枚の はねで おとも たてずに とぶ。あしを つかわず りょう手も こうげきに つかえる。',
  },
  18: {
    name: 'ピジョット', types: ['ノーマル', 'ひこう'], ability: 'いかく',
    ...
    tm: ['のしかかり', 'エアスラッシュ'],
    evolution: null,
    catchRate: 45, baseExp: 216, expType: 'mediumSlow', sprite: SPR.pijotto, backSprite: SPR_BACK.pijotto,
    height: 1.5, weight: 39.5,
    dex: 'じそくは 300キロを こえる。えものを ねらうときの ひこうは まさに だんがんの ようだ。',
  },
  398: {
    name: 'ムクホーク', types: ['ノーマル', 'ひこう'], gen: 4, ability: 'いかく',
  ...
  663: {
    name: 'ファイアロー', types: ['ほのお', 'ひこう'], gen: 6, ability: 'もうか',
  ...
  597: {
    name: 'テッシード', types: ['くさ', 'はがね'], gen: 5, ability: 'がんじょう',
  ...
  598: {
    name: 'ナットレイ', types: ['くさ', 'はがね'], gen: 5, ability: 'がんじょう',
  ...
  220: {
    name: 'ウリムー', types: ['こおり', 'じめん'], gen: 2, ability: 'がんじょう',
  ...
  221: {
    name: 'イノムー', types: ['こおり', 'じめん'], gen: 2, ability: 'がんじょう',
  ...
  66: {
    name: 'ワンリキー', types: ['かくとう'], gen: 1, ability: 'いかく',
  ...
  67: {
    name: 'ゴーリキー', types: ['かくとう'], gen: 1, ability: 'いかく',
