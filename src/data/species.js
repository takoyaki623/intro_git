...
export const SPECIES = {
  1: {
    ...
    learnset: [
      ...
      { lv: 7, move: 'つるのムチ' }, { lv: 10, move: 'どくのこな' },
      { lv: 13, move: 'ねむりごな' }, { lv: 15, move: 'すいとる' },
      { lv: 20, move: 'はっぱカッター' }, { lv: 28, move: 'のしかかり' },
    ],
  ...
  2: {
    ...
    learnset: [
      ...
      { lv: 13, move: 'ねむりごな' }, { lv: 15, move: 'すいとる' },
      { lv: 22, move: 'はっぱカッター' }, { lv: 30, move: 'のしかかり' },
    ],
  ...
  3: {
    ...
    learnset: [
      ...
      { lv: 32, move: 'ねむりごな' }, { lv: 40, move: 'のしかかり' },
      { lv: 50, move: 'はかいこうせん' },
    ],
    evolution: null,
  ...
  13: {
    ...
    learnset: [
      ...
      { lv: 24, move: 'かみつく' }, { lv: 34, move: 'のしかかり' },
      { lv: 44, move: 'はかいこうせん' },
    ],
    evolution: null,
  ...
  16: {
    ...
    learnset: [
      ...
      { lv: 18, move: 'かぜおこし' }, { lv: 26, move: 'むしくい' },
    ],
    evolution: null,
  ...
  130: {
    ...
    learnset: [
      ...
      { lv: 25, move: 'りゅうのいかり' }, { lv: 32, move: 'ハイドロポンプ' },
      { lv: 41, move: 'じしん' }, { lv: 52, move: 'はかいこうせん' },
    ],
    evolution: null,
