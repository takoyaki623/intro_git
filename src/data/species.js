...
export const SPECIES = {
  ...
  258: {
    ...
    catchRate: 45, baseExp: 62, expType: 'mediumSlow', sprite: placeholderSprite(258, '#3878c8', 24, 'quadruped'),
  ...
  259: {
    ...
    catchRate: 45, baseExp: 138, expType: 'mediumSlow', sprite: placeholderSprite(259, '#3060a8', 24, 'quadruped'),
  ...
  260: {
    ...
    tm: ['のしかかり', 'なみのり', 'かみつく'],
    evolution: null,
    catchRate: 45, baseExp: 241, expType: 'mediumSlow', sprite: placeholderSprite(260, '#204878', 24, 'quadruped'),
  ...
  722: {
    ...
    catchRate: 45, baseExp: 64, expType: 'mediumSlow', sprite: placeholderSprite(722, '#5a3820', 24, 'bird'),
  ...
  723: {
    ...
    catchRate: 45, baseExp: 147, expType: 'mediumSlow', sprite: placeholderSprite(723, '#6a4828', 24, 'bird'),
  ...
  724: {
    ...
    tm: ['のしかかり', 'はっぱカッター', 'ねんりき', 'こうごうせい'],
    evolution: null,
    catchRate: 45, baseExp: 239, expType: 'mediumSlow', sprite: placeholderSprite(724, '#2a2018', 24, 'bird'),
  ...
  280: {
    ...
    catchRate: 235, baseExp: 40, expType: 'mediumSlow', sprite: placeholderSprite(280, '#e8a8d8', 24, 'humanoid'),
  ...
  281: {
    ...
    tm: ['ねんりき'],
    evolution: null,
    catchRate: 120, baseExp: 97, expType: 'mediumSlow', sprite: placeholderSprite(281, '#d888c0', 24, 'humanoid'),
  ...
  447: {
    ...
    catchRate: 75, baseExp: 70, expType: 'mediumSlow', sprite: placeholderSprite(447, '#2858a8', 24, 'humanoid'),
    height: 0.7, weight: 20.2,
  ...
  448: {
    ...
    tm: ['ねんりき'],
    evolution: null,
    catchRate: 45, baseExp: 184, expType: 'mediumSlow', sprite: placeholderSprite(448, '#1848a0', 24, 'humanoid'),
  ...
  633: {
    ...
    catchRate: 45, baseExp: 72, expType: 'slow', sprite: placeholderSprite(633, '#4830a0', 24, 'dragon'),
  ...
  634: {
    ...
    tm: ['かみつく'],
    evolution: null,
    catchRate: 45, baseExp: 144, expType: 'slow', sprite: placeholderSprite(634, '#382480', 24, 'dragon'),
  ...
  607: {
    ...
    catchRate: 190, baseExp: 55, expType: 'mediumFast', sprite: placeholderSprite(607, '#4868a8', 24, 'ghost'),
  ...
  608: {
    ...
    tm: ['かえんほうしゃ', 'ねんりき'],
    evolution: null,
    catchRate: 90, baseExp: 130, expType: 'mediumFast', sprite: placeholderSprite(608, '#3858a0', 24, 'ghost'),
  ...
  872: {
    ...
    catchRate: 190, baseExp: 42, expType: 'mediumFast', sprite: placeholderSprite(872, '#c8e8f8', 24, 'insect'),
  ...
  873: {
    ...
    tm: ['ねんりき'],
    evolution: null,
    catchRate: 75, baseExp: 173, expType: 'mediumFast', sprite: placeholderSprite(873, '#a8d8f0', 24, 'insect'),
  ...
  396: {
    ...
    catchRate: 255, baseExp: 49, expType: 'mediumFast', sprite: placeholderSprite(396, '#a06838', 24, 'bird'),
  ...
  397: {
    ...
    tm: [],
    evolution: null,
    catchRate: 120, baseExp: 119, expType: 'mediumFast', sprite: placeholderSprite(397, '#906030', 24, 'bird'),
  ...
  921: {
    ...
    catchRate: 190, baseExp: 46, expType: 'mediumFast', sprite: placeholderSprite(921, '#f0d020', 24, 'quadruped'),
  ...
  922: {
    ...
    tm: ['10まんボルト'],
    evolution: null,
    catchRate: 75, baseExp: 130, expType: 'mediumFast', sprite: placeholderSprite(922, '#e8c018', 24, 'quadruped'),
  ...
  819: {
    ...
    catchRate: 255, baseExp: 52, expType: 'mediumFast', sprite: placeholderSprite(819, '#e08838', 24, 'quadruped'),
    height: 0.3, weight: 2.5,
  ...
  820: {
    ...
    tm: ['のしかかり'],
    evolution: null,
    catchRate: 90, baseExp: 165, expType: 'mediumFast', sprite: placeholderSprite(820, '#c86828', 24, 'quadruped'),
  ...
  179: {
    ...
    catchRate: 235, baseExp: 56, expType: 'mediumSlow', sprite: placeholderSprite(179, '#f8f0d0', 24, 'quadruped'),
  ...
  180: {
    ...
    tm: ['10まんボルト'],
    evolution: null,
    catchRate: 120, baseExp: 128, expType: 'mediumSlow', sprite: placeholderSprite(180, '#f0e8c0', 24, 'quadruped'),
  ...
  661: {
    ...
    catchRate: 255, baseExp: 49, expType: 'mediumFast', sprite: placeholderSprite(661, '#d86030', 24, 'bird'),
  ...
  662: {
    ...
    tm: [],
    evolution: null,
    catchRate: 120, baseExp: 122, expType: 'mediumFast', sprite: placeholderSprite(662, '#c85020', 24, 'bird'),
    height: 0.7, weight: 16.0,
